...
public class AddDislike_R : MonoBehaviour {
	...
	void Start(){
		...
		GetAmountofDisLike_R ();
		var query1 = ParseObject.GetQuery ("JUDGE").WhereEqualTo ("User",ParseUser.CurrentUser.Username).WhereEqualTo("Post_Id",Response_Id);
	...
	void GetAmountofDisLike_R(){
		...
		query.FindAsync ().ContinueWith (t =>
		{
			...
			foreach(var obj in result){
				Label.text=obj["DisLike"].ToString();
			}
