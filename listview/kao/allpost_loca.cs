...
public class allpost_loca : MonoBehaviour {
	...
	{	
		...
		Loom.RunAsync (() => {
			...
			var query = ParseObject.GetQuery ("POST").WhereEqualTo("Location",city).WhereWithinDistance("Post_Geo", point, ParseGeoDistance.FromKilometers(2.5)).OrderByDescending ("createdAt");
